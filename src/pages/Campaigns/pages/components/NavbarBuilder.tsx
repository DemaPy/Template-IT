...
const NavbarBuilder = ({ html, campaign, setDevice }: Props) => {
    ...
    return (
        <div className='sticky flex gap-2 items-center left-0 top-0'>
            ...
            <Button onClick={() => zoomIn()} className='flex gap-2 items-center' size={"sm"} variant={"outline"}>
                +
            </Button>
            <Button onClick={() => zoomOut()} className='flex gap-2 items-center' size={"sm"} variant={"outline"}>
                -
            </Button>
            <Button onClick={() => resetTransform()} className='flex gap-2 items-center' size={"sm"} variant={"outline"}>
                Reset
            </Button>
        </div>
    )
